...
ScrollVelocity.prototype.bind = function () {
  ...
  $(window).on('resize.ScrollVelocity', function () {
    _this.resize();
  ...
  if (!this.allShown) {
    ...
    _.each(this.elements, function (_element) {
      ...
      if (!element.isShown && threshold > element.offsetY - element.bias) {
        ...
        var willMoveOpacity = _.isObject(element.property) && Object.prototype.hasOwnProperty.call(element.property, 'opacity');
...
var ScrollVelocity = __webpack_require__(0);
